...
#define STRING_CONFIG_H_AUTHOR "(Chris Warkocki, SKR Bear w/ BMG Mos, Super PINDA, Moons 0.9, TFT35)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Johnny 5"
...
#define HEATER_0_MAXTEMP 295 + 10
